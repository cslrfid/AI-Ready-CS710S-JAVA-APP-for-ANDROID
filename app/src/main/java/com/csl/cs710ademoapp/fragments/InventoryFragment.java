...
import com.csl.cs710ademoapp.adapters.InventoryAdapter;
...
public class InventoryFragment extends CommonFragment {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        MainActivity.csLibrary4A.appendToLog("InventoryFragment: onOptionsItemSelected");
        ...
        switch (item.getItemId()) {
            case R.id.menuAction_1:
                MainActivity.csLibrary4A.appendToLog("InventoryFragment: onOptionsItemSelected: clearTagsList");
