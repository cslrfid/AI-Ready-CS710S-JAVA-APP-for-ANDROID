...
public class InventoryRfidiMultiFragment extends CommonFragment {
    ...
    void startStopHandler(boolean buttonTrigger) {
        ...
        if (started == false) {
            ...
            MainActivity.csLibrary4A.appendToLogView("CANCELLING. Set taskCancelReason");
    ...
    void startInventoryTask() {
        ...
        if (mDid != null) {
            ...
            if (bNeedSelectedTagByTID) {
                if (checkBoxFilterFdTag.isChecked()) MainActivity.csLibrary4A.setSelectedTagByTID(mDid, -1);
                else {
