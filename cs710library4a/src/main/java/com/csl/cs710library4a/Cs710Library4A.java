...
public class Cs710Library4A {
    ...
    boolean setOnlyPowerLevel(long pwrlevel) {
        return csReaderConnector.rfidReader.setOnlyPowerLevel(pwrlevel);
    }
    boolean setSelectCriteria3(int index, boolean enable, int target, int action, int delay, int bank, int offset, String mask, int maskblen) {
        return setSelectCriteria3(index, enable, target, action, delay, bank, offset, mask, maskblen);
    }
    ...
    RegionCodes[] getRegionList1() {
        ...
        csReaderConnector.rfidReader.regionCode = RfidReader.RegionCodes.values()[iValue];
        if (DEBUG) appendToLog("3C getCountryList: regionCode is " + csReaderConnector.rfidReader.regionCode.toString());
        return regionList;
    }
    ...
    RegionCodes[] getRegionList() {
        ...
        if (regionList != null) {
            if (DEBUG) appendToLog(String.format("2b getCountryList: countryInList = %d, regionCode = %s", csReaderConnector.rfidReader.countryInList, (csReaderConnector.rfidReader.regionCode != null ? csReaderConnector.rfidReader.regionCode.toString() : "")));
            if (csReaderConnector.rfidReader.countryInList < 0) {
                if (csReaderConnector.rfidReader.regionCode == null) csReaderConnector.rfidReader.regionCode = regionList[0];
                csReaderConnector.rfidReader.countryInList = 0;
                for (int i = 0; i < regionList.length; i++) {
                    if (csReaderConnector.rfidReader.regionCode == regionList[i]) {
                        csReaderConnector.rfidReader.countryInList = i;
                        break;
                    }
                }
                ...
                csReaderConnector.rfidReader.regionCode = regionList[csReaderConnector.rfidReader.countryInList];
                if (DEBUG) appendToLog(String.format("2C getCountryList: countryInList = %d, regionCode = %s", csReaderConnector.rfidReader.countryInList, csReaderConnector.rfidReader.regionCode.toString()));
            }
        } else csReaderConnector.rfidReader.regionCode = null;
        return regionList;
    }
    ...
    public boolean setInvAlgo(boolean dynamicAlgo) {
        ...
        if (bValue) csReaderConnector.rfidReader.invAlgoSetting = dynamicAlgo;
...
//                if (retValue)
    ...
    public void saveSetting2File() {
        ...
        try {
            ...
            csReaderConnector.settingData.write2FileStream(stream, "countryInList," + String.valueOf(getCountryNumberInList() + "\n"));
            if (getChannelHoppingStatus() == false) csReaderConnector.settingData.write2FileStream(stream, "channel," + String.valueOf(getChannel() + "\n"));

            csReaderConnector.settingData.write2FileStream(stream, "antennaPower," + String.valueOf(rfidReaderChip.rx000Setting.getAntennaPower(0) + "\n"));
            csReaderConnector.settingData.write2FileStream(stream, "population," + String.valueOf(getPopulation() +"\n"));
            csReaderConnector.settingData.write2FileStream(stream, "querySession," + String.valueOf(getQuerySession() + "\n"));
            csReaderConnector.settingData.write2FileStream(stream, "queryTarget," + String.valueOf(getQueryTarget() + "\n"));
            csReaderConnector.settingData.write2FileStream(stream, "tagFocus," + String.valueOf(getTagFocus() + "\n"));
            csReaderConnector.settingData.write2FileStream(stream, "fastId," + String.valueOf(getFastId() + "\n"));
            csReaderConnector.settingData.write2FileStream(stream, "invAlgo," + String.valueOf(getInvAlgo() + "\n"));
            csReaderConnector.settingData.write2FileStream(stream, "retry," + String.valueOf(getRetryCount() + "\n"));
            csReaderConnector.settingData.write2FileStream(stream, "currentProfile," + String.valueOf(getCurrentProfile() + "\n"));
            csReaderConnector.settingData.write2FileStream(stream, "rxGain," + String.valueOf(getRxGain() + "\n"));

            csReaderConnector.settingData.write2FileStream(stream, "deviceName," + getBluetoothICFirmwareName() + "\n");
            csReaderConnector.settingData.write2FileStream(stream, "batteryDisplay," + String.valueOf(getBatteryDisplaySetting() + "\n"));
            csReaderConnector.settingData.write2FileStream(stream, "rssiDisplay," + String.valueOf(getRssiDisplaySetting() + "\n"));
            csReaderConnector.settingData.write2FileStream(stream, "tagDelay," + String.valueOf(getTagDelay() + "\n"));
            csReaderConnector.settingData.write2FileStream(stream, "cycleDelay," + String.valueOf(getCycleDelay() + "\n"));
            csReaderConnector.settingData.write2FileStream(stream, "intraPkDelay," + String.valueOf(getIntraPkDelay() + "\n"));
            csReaderConnector.settingData.write2FileStream(stream, "dupDelay," + String.valueOf(getDupDelay() + "\n"));
            ...
            csReaderConnector.settingData.write2FileStream(stream, "inventoryBeep," + String.valueOf(getInventoryBeep() + "\n"));
            csReaderConnector.settingData.write2FileStream(stream, "inventoryBeepCount," + String.valueOf(getBeepCount() + "\n"));
            csReaderConnector.settingData.write2FileStream(stream, "inventoryVibrate," + String.valueOf(getInventoryVibrate() + "\n"));
            csReaderConnector.settingData.write2FileStream(stream, "inventoryVibrateTime," + String.valueOf(getVibrateTime() + "\n"));
            csReaderConnector.settingData.write2FileStream(stream, "inventoryVibrateMode," + String.valueOf(getVibrateModeSetting() + "\n"));
            csReaderConnector.settingData.write2FileStream(stream, "inventoryVibrateWindow," + String.valueOf(getVibrateWindow() + "\n"));

            csReaderConnector.settingData.write2FileStream(stream, "savingFormat," + String.valueOf(getSavingFormatSetting() + "\n"));
            csReaderConnector.settingData.write2FileStream(stream, "csvColumnSelect," + String.valueOf(getCsvColumnSelectSetting() + "\n"));
            csReaderConnector.settingData.write2FileStream(stream, "saveFileEnable," + String.valueOf(getSaveFileEnable() + "\n"));
            csReaderConnector.settingData.write2FileStream(stream, "saveCloudEnable," + String.valueOf(getSaveCloudEnable() + "\n"));
            csReaderConnector.settingData.write2FileStream(stream, "saveNewCloudEnable," + String.valueOf(getSaveNewCloudEnable() + "\n"));
            csReaderConnector.settingData.write2FileStream(stream, "saveAllCloudEnable," + String.valueOf(getSaveAllCloudEnable() + "\n"));
            csReaderConnector.settingData.write2FileStream(stream, "serverLocation," + getServerLocation() + "\n");
            csReaderConnector.settingData.write2FileStream(stream, "serverTimeout," + String.valueOf(getServerTimeout() + "\n"));
...
*/
            csReaderConnector.settingData.write2FileStream(stream, "userDebugEnable," + String.valueOf(getUserDebugEnable() + "\n"));
