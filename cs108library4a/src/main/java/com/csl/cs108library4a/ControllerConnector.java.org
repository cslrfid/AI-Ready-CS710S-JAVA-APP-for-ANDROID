...
class ControllerConnector {
    ...
    ControllerConnector(Context context, TextView mLogView) {
    ...
    String getSerialNumber() {
        if (serialNumber == null) {
            ...
            if (true) appendToLog("string = " + string + " from serial " + byteArrayToString(serialNumber) + ", revised = " + byteArrayToString(bytes));
            return string;
        }
    }
    ...
    ArrayList<ControllerPayloadEvents> controllerToWrite = new ArrayList<>();
    ...
    boolean isMatchControllerToWrite(Cs108ReadData cs108ReadData) {
        boolean match = false;
